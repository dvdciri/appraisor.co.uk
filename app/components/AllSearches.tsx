    ...
    <div className="border border-gray-500/50 rounded-2xl p-6 shadow-2xl" style={{ backgroundColor: 'rgba(30, 15, 45, 0.9)' }}>
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          <button
            onClick={onBack}
            className="p-2 rounded-lg bg-gray-800/30 hover:bg-gray-700/30 transition-colors"
          >
        ...
        {filteredSearches.length === 0 ? (
          ...
          filteredSearches.map((search) => (
            <div
              ...
              className="flex items-center justify-between p-3 rounded-lg bg-gray-800/30 hover:bg-gray-700/30 cursor-pointer transition-colors"
            >
