...
export default function GenericPanel({ 
  ...
  return (
    <>
      ...
      {isLargeScreen && (
        <div className={`w-[720px] bg-black/25 backdrop-blur-2xl border border-gray-500/30 flex flex-col shadow-2xl rounded-2xl mr-6 mt-6 mb-6 h-[calc(100vh-3rem)] ${className}`}>
      ...
      {/* Mobile Panel Overlay - Only for small screens */}
      {!isLargeScreen && (
